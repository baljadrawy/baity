...
async function main() {
  ...
  const jobMenuItems: Array<{
    ...
    {
      title: 'تنظيف طاولة الطعام بعد الأكل',
      iconEmoji: '🧽',
      reward: 3,
      minAge: 6,
      maxAge: 12,
    ...
    {
      title: 'مساعدة في غسيل السيارة من الخارج',
      iconEmoji: '🚙',
      reward: 15,
      minAge: 10,
      difficulty: 'HARD',
