/**
 * PATCH  /api/v1/archive/[id] — تعديل وثيقة (الحقول النصية + التواريخ + tags)
 * DELETE /api/v1/archive/[id] — حذف وثيقة (soft delete + محاولة حذف من Storage)
 */
...
import { updateArchiveSchema } from '@/features/archive/schemas';
...
export async function PATCH(req: NextRequest, { params }: Params) {
  try {
    ...
    const data = updateArchiveSchema.parse(body);
